...
CREATE TABLE `cc_agents` (
  ...
  `wrapup_end_time` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
CREATE TABLE `cc_flows` (
  ...
  `max_wrapup_time` int(11) unsigned NOT NULL DEFAULT '0',
  `dissuading_hangup` int(11) unsigned NOT NULL DEFAULT '0',
  `dissuading_onhold_th` int(11) unsigned NOT NULL DEFAULT '0',
  `dissuading_ewt_th` int(11) unsigned NOT NULL DEFAULT '0',
  `dissuading_qsize_th` int(11) unsigned NOT NULL DEFAULT '0',
...
INSERT INTO `domain` VALUES (2,'opensips.my','','0000-00-00 00:00:00');
...
--
-- Table structure for table `jwt_profiles`
--

DROP TABLE IF EXISTS `jwt_profiles`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `jwt_profiles` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `jwt_tag_idx` (`tag`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `jwt_profiles`
--

LOCK TABLES `jwt_profiles` WRITE;
/*!40000 ALTER TABLE `jwt_profiles` DISABLE KEYS */;
/*!40000 ALTER TABLE `jwt_profiles` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `jwt_secrets`
--
...
--
-- Dumping data for table `jwt_secrets`
--

LOCK TABLES `jwt_secrets` WRITE;
/*!40000 ALTER TABLE `jwt_secrets` DISABLE KEYS */;
/*!40000 ALTER TABLE `jwt_secrets` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `qr_profiles`
--

DROP TABLE IF EXISTS `qr_profiles`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `qr_profiles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `profile_name` char(64) NOT NULL,
  `warn_threshold_asr` double NOT NULL DEFAULT '-1',
  `warn_threshold_ccr` double NOT NULL DEFAULT '-1',
  `warn_threshold_pdd` double NOT NULL DEFAULT '-1',
  `warn_threshold_ast` double NOT NULL DEFAULT '-1',
  `warn_threshold_acd` double NOT NULL DEFAULT '-1',
  `crit_threshold_asr` double NOT NULL DEFAULT '-1',
  `crit_threshold_ccr` double NOT NULL DEFAULT '-1',
  `crit_threshold_pdd` double NOT NULL DEFAULT '-1',
  `crit_threshold_ast` double NOT NULL DEFAULT '-1',
  `crit_threshold_acd` double NOT NULL DEFAULT '-1',
  `warn_penalty_asr` double NOT NULL DEFAULT '0.5',
  `warn_penalty_ccr` double NOT NULL DEFAULT '0.5',
  `warn_penalty_pdd` double NOT NULL DEFAULT '0.5',
  `warn_penalty_ast` double NOT NULL DEFAULT '0.5',
  `warn_penalty_acd` double NOT NULL DEFAULT '0.5',
  `crit_penalty_asr` double NOT NULL DEFAULT '0.05',
  `crit_penalty_ccr` double NOT NULL DEFAULT '0.05',
  `crit_penalty_pdd` double NOT NULL DEFAULT '0.05',
  `crit_penalty_ast` double NOT NULL DEFAULT '0.05',
  `crit_penalty_acd` double NOT NULL DEFAULT '0.05',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `qr_profiles`
--

LOCK TABLES `qr_profiles` WRITE;
/*!40000 ALTER TABLE `qr_profiles` DISABLE KEYS */;
/*!40000 ALTER TABLE `qr_profiles` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `rc_clients`
--

DROP TABLE IF EXISTS `rc_clients`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rc_clients` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `client_id` char(64) NOT NULL,
  `wholesale_rate` int(11) unsigned NOT NULL DEFAULT '0',
  `retail_rate` int(11) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
--
-- Dumping data for table `rc_clients`
--

LOCK TABLES `rc_clients` WRITE;
/*!40000 ALTER TABLE `rc_clients` DISABLE KEYS */;
/*!40000 ALTER TABLE `rc_clients` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `rc_demo_ratesheet`
--

DROP TABLE IF EXISTS `rc_demo_ratesheet`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rc_demo_ratesheet` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `prefix_idx` (`prefix`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `rc_demo_ratesheet`
--

LOCK TABLES `rc_demo_ratesheet` WRITE;
/*!40000 ALTER TABLE `rc_demo_ratesheet` DISABLE KEYS */;
/*!40000 ALTER TABLE `rc_demo_ratesheet` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `rc_ratesheets`
--

DROP TABLE IF EXISTS `rc_ratesheets`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rc_ratesheets` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `table_idx` (`ratesheet_table`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `rc_ratesheets`
--

LOCK TABLES `rc_ratesheets` WRITE;
/*!40000 ALTER TABLE `rc_ratesheets` DISABLE KEYS */;
/*!40000 ALTER TABLE `rc_ratesheets` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `rc_vendors`
--

DROP TABLE IF EXISTS `rc_vendors`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rc_vendors` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `vendor_id` char(64) NOT NULL,
  `vendor_rate` int(11) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
--
-- Dumping data for table `rc_vendors`
--

LOCK TABLES `rc_vendors` WRITE;
/*!40000 ALTER TABLE `rc_vendors` DISABLE KEYS */;
/*!40000 ALTER TABLE `rc_vendors` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `version` VALUES ('acc',7),('active_watchers',12),('address',5),('b2b_entities',2),('b2b_logic',3),('b2b_sca',1),('cachedb',2),('carrierfailureroute',2),('carrierroute',3),('cc_agents',2),('cc_calls',2),('cc_cdrs',1),('cc_flows',2),('closeddial',1),('clusterer',4),('cpl',2),('dbaliases',2),('dialog',11),('dialplan',5),('dispatcher',8),('domain',3),('domainpolicy',3),('dr_carriers',3),('dr_gateways',6),('dr_groups',2),('dr_partitions',1),('dr_rules',4),('emergency_report',1),('emergency_routing',1),('emergency_service_provider',1),('fraud_detection',1),('freeswitch',1),('globalblacklist',2),('grp',3),('imc_members',2),('imc_rooms',2),('jwt_profiles',1),('jwt_secrets',1),('load_balancer',3),('location',1013),('missed_calls',5),('presentity',5),('pua',8),('qr_profiles',1),('rc_clients',1),('rc_demo_ratesheet',1),('rc_ratesheets',1),('rc_vendors',1),('registrant',2),('re_grp',2),('rls_presentity',1),('rls_watchers',2),('route_tree',2),('rtpengine',1),('rtpproxy_sockets',0),('silo',6),('sip_trace',5),('smpp',1),('speed_dial',3),('subscriber',7),('tls_mgm',3),('uri',2),('userblacklist',2),('usr_preferences',3),('watchers',4),('xcap',4);
...
-- Dump completed on 2020-08-08 23:23:48
